package es.ramirez.me.configuration;
...
public class SwaggerConfig {
	...
	public Docket apiDocker() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("es.ramirez.me.controller"))
	...
	private ApiInfo metaInfo() {
		...
		ApiInfo apiInfo = new ApiInfo(
                "Spring Boot Swagger Evento API",
                "Spring Boot Swagger Evento API for Lucaticket",
                "1.0",
                "Terms of Service",
